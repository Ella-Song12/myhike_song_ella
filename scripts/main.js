...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection).orderBy("hike_time").get()   //the collection called "hikes"
        .then(allHikes => {
...
function updateBookmark(hikeID) {
    ...
    currentUser.get().then(userDoc=>{
        ...
        let isBookmarked = bookmarks.includes(hikeID); //check if this hikeID exists in bookmark array
        ...
        if(isBookmarked){
            currentUser.update({
                ...
                console.log("item was removed"+hikeID)
